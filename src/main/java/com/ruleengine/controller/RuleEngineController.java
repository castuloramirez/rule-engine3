...
import com.ruleengine.model.EmailRecord;
import com.ruleengine.model.EmailRepository;
import com.ruleengine.model.RuleEngineResponse;
...
public class RuleEngineController {
    ...
    private static final Logger log = LogManager.getLogger(RuleEngineController.class);

    private final RuleEngineService ruleEngineService;
    private final EmailRepository emailRepository;

    public RuleEngineController(RuleEngineService ruleEngineService, EmailRepository emailRepository) {
